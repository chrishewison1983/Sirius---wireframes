  ...
  grunt.initConfig({
	...
	uglify: {
	  ...
	  frameworksdebug: {
		...
		dest: '../../debug/js/V8/frameworks.js'
	  },
	  frameworks: {
		src: [
			'../../js/library/modernizr.js',
		...
		dest: '../../production/js/V8/frameworks.js'
	  },
	  applicationdebug: {
		options: {
			beautify:true
		...
		src: [
			...
			// '../../js/global/megamenu-native.js',
               ...
               // '../../production/js/V8/orbit.js'
		],
		dest: '../../debug/js/V8/application.js'		// Change to application specific directory
	  },
	  application: {
		src: [
			'bower_components/foundation/js/foundation/foundation.js',
		...
		dest: '../../production/js/V8/application.js'		// Change to application specific directory
	  }
	},
	compass: {
		development: {
	...
	stencil: {
		main: { // task target name
		  ...
		  files: [{
			...
			cwd: 'pages/',
			src: '**/*.dot.html',
			dest: '../../html/V8',				// Change to application specific directory
			ext: '.html'
		  }]
		}
	},
