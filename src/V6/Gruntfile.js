  ...
  grunt.initConfig({
	...
	uglify: {
	  ...
	  frameworksdebug: {
		...
		dest: '../../debug/js/V6/frameworks.js'
	  },
	  frameworks: {
		src: [
			'../../js/library/modernizr.js',
		...
		dest: '../../production/js/V6/frameworks.js'
	  },
	  applicationdebug: {
		options: {
			beautify:true
		...
		src: [
			...
			// '../../js/global/megamenu-native.js',
               ...
               // '../../production/js/V6/orbit.js'
		],
		dest: '../../debug/js/V6/application.js'		// Change to application specific directory
	  },
	  application: {
		src: [
			'bower_components/foundation/js/foundation/foundation.js',
		...
		dest: '../../production/js/V6/application.js'		// Change to application specific directory
	  }
	},
	compass: {
		development: {
	...
	stencil: {
		main: { // task target name
		  ...
		  files: [{
			...
			cwd: 'pages/',
			src: '**/*.dot.html',
			dest: '../../html/V6',				// Change to application specific directory
			ext: '.html'
		  }]
		}
	},
