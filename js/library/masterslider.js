...
;(function($){
	...
	p.hide = function(fast){
		if(fast){
			...
			this.hideTo = setTimeout(function($element){
				CTween.fadeOut($element , 410 , false);
			}, 20 , this.$element);
		}
	...
	p.visible = function(){
		...
		CTween.fadeIn(this.$element , 410 , false);
...
;(function($){
	...
	p.hide = function(fast){
		...
		CTween.fadeOut(this.$prev , 410 , false);
		CTween.fadeOut(this.$next , 410 , false);
	...
	p.visible = function(){
		if(this.detached) return;
		CTween.fadeIn(this.$prev , 410 );
		CTween.fadeIn(this.$next , 410 );
...
;(function($){
	...
	MSSlideInfo.fadeDuratation = 410;
