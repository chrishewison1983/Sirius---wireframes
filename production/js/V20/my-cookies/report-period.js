...
if ($.cookie("create-report-step-1") == "true") {
     $('#reporting-period-completed h1 div').text('reporting period');
}

if ($.cookie("create-report-step-2") == "true") {
     $('#reporting-period-completed h1 div').text('report due date');
}

if ($.cookie("create-report-step-3") == "true") {
     $('#reporting-period-completed h1 div').text('report type');
}
...
$("#confirm-abandon-report").on("click", function (e) {
     $.cookie("confirm-abandon-report", true, {path:'/'});
});

if ($.cookie("confirm-abandon-report") == 'true') {
     // Hides the cta
     ...
     // Clears the Cookies
     setTimeout(function() {
          $.cookie("confirm-abandon-report", false, {path:'/'});
          $('#reporting-period-completed').slideUp();
     }, 5000);

     $('#reporting-period-completed').slideDown();
     $('#reporting-period-completed h1').html('<span></span>The report has been abandoned');
