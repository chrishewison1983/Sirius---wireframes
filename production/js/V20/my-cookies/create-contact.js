...
if ($.cookie("add-contact-journey") == 'true') {
     // Changes breadcrumb
     $('nav.breadcrumb').html('<a href="../index.html">Dashboard</a> <div class="separator"> &gt; </div> <a href="../4-client-page/4a-new-client.html"> <div class="client-title">Mr</div> <div class="client-first-name">Gerald</div> <div class="client-last-name">Brackens</div> </a> <div class="separator"> &gt; </div> <span>Create contact</span>');
     ...
     // $('input[name="contact-organisation"][value="Yes"]').change(function(){
          // if ($('input[name="contact-organisation"][value="Yes"]').is(":checked")) {
          //
          //      // $('#create-contact').removeAttr('href').addClass('de-activate');
          //
          //      $('#contact-correspondence-name, #contact-company-name').keyup(function() {
          //
          //           var empty = false;
          //           $('#contact-correspondence-name, #contact-company-name').each(function() {
          //                if ($(this).val() == '') {
          //                     empty = true;
          //                }
          //           });
     ...
     // $('input[name="contact-organisation"][value="No"]').change(function(){
          // if ($('input[name="contact-organisation"][value="No"]').is(":checked")) {
          //
          //      // $('#create-contact').removeAttr('href').addClass('de-activate');
          //
