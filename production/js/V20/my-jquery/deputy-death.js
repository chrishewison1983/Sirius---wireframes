...
// Modal information
$("#confirm-deputy-death").click(function() {
     var deputyTitle = $('#section-header h1 .deputy-title-answer').text();
     var deputyFirstName = $('#section-header h1 .deputy-first-name-answer').text();
     var deputyLastName = $('#section-header h1 .deputy-last-name-answer').text();
     $('#deputy-death-modal h2').text(deputyTitle + ' ' + deputyFirstName + ' ' + deputyLastName);
});
