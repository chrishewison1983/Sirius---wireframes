...
function addInput(divName){
     if (counter == limit)  {
          ...
          newdiv.innerHTML = "<a class=\"close close-question\"></a><label for='visit-question-" + (counter + 1) + "'> <span class='number'>" + (counter + 1) + "</span> Question</label><input type='text' name='myInputs[]' id='visit-question-" + (counter + 1) + "'>";
...
$(document).ready(function() {
     $(document).on('click', 'a.close-question', function(e) {
          // e.preventDefault();
          $(this).parent().remove();
     });
});
...
// Side panel content
$('.accordion.commission-visit').find('#step-1, #step-2, #step-3, #step-4, #step-5, #step-6').addClass('inactive');
$('.accordion.commission-visit').find('.place-holder-text').show();
$('.accordion.commission-visit').find('.commission-visit-info').hide();
...
$(document).ready(function() {
     ...
     $('ul#commission-visit-client li a, ul#commission-visit-deputies li a').on('click', function(e) {
          ...
          $(this).siblings('.hidden-content').toggle().css('display', 'inline-block');
...
if ($.cookie("completed-step-1") == 'true') {
     $('.accordion.commission-visit').find('#step-1').removeClass('inactive');
     $('.accordion.commission-visit #step-1').find('.place-holder-text').hide();
     $('.accordion.commission-visit #step-1').find('.commission-visit-info').show();
}
...
function addInput2(divName){
     if (counter == limit)  {
          ...
          var newdiv = document.createElement('div');
          newdiv.innerHTML = "<a class=\"close close-question\"></a><label for='visit-third-question-" + (counter + 1) + "'> <span class='number'>" + (counter + 1) + "</span> Question</label><input type='text' name='myInputs[]' id='visit-third-question-" + (counter + 1) + "'>";
          document.getElementById(divName).appendChild(newdiv);
          counter++;
     }
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") == 'true') {
     $('.accordion.commission-visit').find('#step-1, #step-2').removeClass('inactive');
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2').find('.place-holder-text').hide();
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2').find('.commission-visit-info').show();
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") == 'true') {
     $('.accordion.commission-visit').find('#step-1, #step-2, #step-3').removeClass('inactive');
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3').find('.place-holder-text').hide();
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3').find('.commission-visit-info').show();
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") && $.cookie("completed-step-4") == 'true') {
     $('.accordion.commission-visit').find('#step-1, #step-2, #step-3, #step-4').removeClass('inactive');
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3, .accordion.commission-visit #step-4').find('.place-holder-text').hide();
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3, .accordion.commission-visit #step-4').find('.commission-visit-info').show();
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") && $.cookie("completed-step-4") && $.cookie("completed-step-5") == 'true') {
     $('.accordion.commission-visit').find('#step-1, #step-2, #step-3, #step-4, #step-5').removeClass('inactive');
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3, .accordion.commission-visit #step-4, .accordion.commission-visit #step-5').find('.place-holder-text').hide();
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3, .accordion.commission-visit #step-4, .accordion.commission-visit #step-5').find('.commission-visit-info').show();
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") && $.cookie("completed-step-4") && $.cookie("completed-step-5") && $.cookie("completed-step-6") == 'true') {
     $('.accordion.commission-visit').find('#step-1, #step-2, #step-3, #step-4, #step-5, #step-6').removeClass('inactive');
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3, .accordion.commission-visit #step-4, .accordion.commission-visit #step-5, .accordion.commission-visit #step-6').find('.place-holder-text').hide();
     $('.accordion.commission-visit #step-1, .accordion.commission-visit #step-2, .accordion.commission-visit #step-3, .accordion.commission-visit #step-4, .accordion.commission-visit #step-5, .accordion.commission-visit #step-6').find('.commission-visit-info').show();
}
