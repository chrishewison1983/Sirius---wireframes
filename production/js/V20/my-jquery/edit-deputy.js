...
// Show's the values for Carla Frith (Deputy 2)
...
// Show's the values for Melanie Rand (Deputy 3)
if (window.location.href.indexOf("edit-deputy-3") != -1) {
     ...
     // Changes the footer content
     $('#add-deputy-step-1, #add-deputy-step-2, #add-deputy-step-3').text('Save & update deputy');
     $('#add-deputy-step-1, #add-deputy-step-2, #add-deputy-step-3').attr('href', '../4-client-page/4a-new-client.html#PFA');
     $('#add-deputy-step-1, #add-deputy-step-2, #add-deputy-step-3').removeClass('de-activate');
     $('#add-another-deputy').hide();
...
if (window.location.href.indexOf("lay") != -1) {
     ...
     $('.breadcrumb').html('<a href="../index.html">Dashboard</a> <div class="separator"> > </div> <a href="../14-deputy-page/14a-deputy-page.html">Mrs Lara Stevens</a> <div class="separator"> > </div> <span>Check deputy details</span>');
...
if (window.location.href.indexOf("pro") != -1) {
     ...
     $('.deputy-order-details').hide();
     $('.breadcrumb').html('<a href="../index.html">Dashboard</a> <div class="separator"> > </div> <a href="../14-deputy-page/14b-pro-deputy-page.html">Connor, Caur &amp; Burrows</a> <div class="separator"> > </div> <span>Check deputy details</span>');
...
if (window.location.href.indexOf("pub") != -1) {
     ...
     $('.deputy-order-details').hide();
     $('.breadcrumb').html('<a href="../index.html">Dashboard</a> <div class="separator"> > </div> <a href="../14-deputy-page/14c-pa-deputy-page.html">Weston Parpenham</a> <div class="separator"> > </div> <span>Check deputy details</span>');
