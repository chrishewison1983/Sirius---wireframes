...
if ($.cookie("contact-added") == 'true') {
               ...
               <a class="correspondent">
                    <div class="wrapper">
                         <div class="contact-name">
                              <span class="contact-name-value"><div class="contact-first-name-answer">TrustMe</div> <div class="contact-last-name-answer">Limited</div></span>
                         ...
                         <div class="company-name">
                              <div>
                                   Company name:
                                   <span class="contact-company-name-answer">TrustMe</span>
                                   Company ref:
                                   <span class="contact-last-name-answer">Limited</span>
                              </div>
                         </div>
                    </div>
     			...
     			<span class="sub-text">
                    ...
                    <div class="contact-info">
                         ...
                         <div class="row">
                              ...
                              <div class="large-4 large-uncentered columns">
                                   <span>Notes: <strong class="contact-notes-answer">None</strong></span>
                              </div>
                              <div class="large-4 large-uncentered columns">
                                   <span>
                                        Interpreter required?:
                                        <strong class="contact-interpreter-answer">No</strong>
                                        <strong class="contact-interpreter-details-answer">No</strong>
                                   </span>
                              </div>
                         </div>
                    </div>
     ...
     $('#client-overview .tabs .tab-link[data-tab="summary-tab-4"]').addClass('current');
