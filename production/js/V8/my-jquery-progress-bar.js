...
if ($('.visit-commission').hasClass('step-2')) {
     ...
     $('.border').addClass('sixteen-percent');
...
if ($.cookie("completed-step-1") == 'true') {
     ...
     $('.commission-visit .border').addClass('sixteen-percent').removeClass('thirty-eight-percent, sixty-percent, eighty-percent, one-hundred-percent');
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") == 'true') {
     ...
     $('.commission-visit .border').addClass('thirty-eight-percent').removeClass('sixteen-percent, sixty-percent, eighty-percent, one-hundred-percent');
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") == 'true') {
     ...
     $('.commission-visit .border').addClass('sixty-percent').removeClass('sixteen-percent, thirty-eight-percent, eighty-percent, one-hundred-percent');
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") && $.cookie("completed-step-4") == 'true') {
     ...
     $('.commission-visit .border').addClass('eighty-percent').removeClass('sixteen-percent, thirty-eight-percent, sixty-percent, one-hundred-percent');
}
...
if ($.cookie("completed-step-1") && $.cookie("completed-step-2") && $.cookie("completed-step-3") && $.cookie("completed-step-4") && $.cookie("completed-step-5") == 'true') {
     ...
     $('.commission-visit .border').addClass('one-hundred-percent').removeClass('sixteen-percent, thirty-eight-percent, sixty-percent, eighty-percent');
}
