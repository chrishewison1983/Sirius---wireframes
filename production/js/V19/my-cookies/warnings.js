...
if ($.cookie("new-warning-completed") == 'true') {
     ...
     $('#client-overview li').removeClass('current');
     $('#client-overview li[data-tab="summary-tab-3"]').addClass('current');
     $('#client-overview #summary-tab-3').addClass('current');
     $('#client-overview #summary-tab-2, #client-overview #summary-tab-§, #client-overview #summary-tab-4, #client-overview #summary-tab-5, #client-overview #summary-tab-6, #client-overview #summary-tab-7, #client-overview #summary-tab-8').removeClass('current');
