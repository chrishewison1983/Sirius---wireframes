...
$(document).ready(function () {
     ...
     if (window.location.href.indexOf("HandW") != -1) {
          ...
          $('.normal-status').css('display', 'inline-block');
          $('#hub-filter-panel #handw-actions').addClass('checked');
          // $('#hub-filter-panel #handw-actions h2 .icon').removeClass('white');
          $('#hub-filter-panel #client-actions input[value="client"]').removeAttr('checked');
          $('#hub-filter-panel #handw-actions input[value="handw"]').attr('checked', 'checked');
          $('#hub-filter-panel #client-actions, #hub-filter-panel #pfa-actions').removeClass('checked');
          $('.handw-actions').show();
          ...
          // $('#section-header.client-page .breadcrumb').html('<a href="../index.html">My tasks</a> <div class="separator"> > </div> <a href="4a-new-client.html">Client summary</a> <div class="separator"> > </div> <span>H & W | 19273638</span>');
     }
     ...
     if (window.location.href.indexOf("PFA") != -1) {
          ...
          // $('.add-deputy-link').show();
          $('.normal-status').css('display', 'inline-block');
          $('#hub-filter-panel #pfa-actions').addClass('checked');
          // $('#hub-filter-panel #pfa-actions h2 .icon').removeClass('white');
          $('#hub-filter-panel #client-actions input[value="client"]').removeAttr('checked');
          $('#hub-filter-panel #pfa-actions input[value="pfa"]').attr('checked', 'checked');
          $('#hub-filter-panel #client-actions, #hub-filter-panel #handw-actions').removeClass('checked');
          $('.pfa-actions').show();
