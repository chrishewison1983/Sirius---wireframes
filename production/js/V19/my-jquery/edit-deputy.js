...
if (window.location.href.indexOf("edit-deputy-1") != -1) {
     ...
     $('#add-deputy-step-1, #add-deputy-step-2, #add-deputy-step-3').attr('href', '../4-client-page/4a-new-client.html');
...
$("#confirm-unlink-deputy").click( function(){
     ...
     var deputyNumber = parseInt($('ul.client-details li[data-tab="summary-tab-9"] span').text());

     $('ul.client-details li[data-tab="summary-tab-9"] span').text(deputyNumber - 1);
