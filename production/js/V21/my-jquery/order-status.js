...
$("#order-status-pfa").on("change", function (e) {
     if ($(this).val() === 'Closed') {
          ...
          $('#order-status-button-pfa').removeClass('de-activate').attr('href', '../4-client-hub/4a-new-client.html#PFA');
     }
});
...
$("#order-status-hw").on("change", function (e) {
     if ($(this).val() === 'Closed') {
          ...
          $('#order-status-button-hw').removeClass('de-activate').attr('href', '../4-client-hub/4a-new-client.html#HandW');
     }
});
