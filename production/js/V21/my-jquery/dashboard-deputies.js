...
$('.view-full-details').click( function(e){
     ...
     $(`#dashboard-deputies-table tr.summary-row[data-value="${dataValue}"]`).toggleClass('open');
     $(`#dashboard-deputies-table tr.details-row[data-value="${dataValue}"]`).toggle();
});
...
$('.filter-category-deputies').change(function(){
     ...
     if($(this).val() == "My deputies") {
          ...
          $('#dashboard-deputies-table tbody tr.details-row').hide();
     ...
     }  else if ($(this).val() == "Search deputies") {
          $('.deputy-filter').find('.filter').css('display', 'inline-block');
          $('.deputy-filter').find('.step-1').hide();
          $('.deputy-filter').find('.step-2').hide();
          $('.deputy-filter').find('.step-1.filter-e').css('display', 'inline-block');
...
/////////////// ------------------------------ OPTION 5 - START ------------------------------ ///////////////
$('.filter-search-deputies').keyup(function(){
     $('.deputy-filter').find('.step-1.filter-e').addClass('step-1-filter-active');
});
/////////////// ------------------------------ OPTION 5 - END ------------------------------ ///////////////
     ...
     $('input[name="re-assign-deputy"]').click(function(){
          ...
          if($(this).is(":checked")) {
               ...
               if ($('.filter-category-deputies').val() === '') {
                    ...
                    $('.deputy-filter').find('.cancel-re-assign').show();
               ...
               if ($('input[name="re-assign-deputy"][checked]').length === 0) {
                    ...
                    $('.deputy-filter').find('.filter-select-all-clear, .filter-select-all-clear .clear-filter').show();
                    $('.deputy-filter').find('.step-2, .filter-select-all-clear .cancel-re-assign').hide();
                    $('.deputy-filter').find('.main-filter').addClass('re-assign-active');
